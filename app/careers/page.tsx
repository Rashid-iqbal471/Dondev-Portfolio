        ...
        <div className="container mx-auto px-6 text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Be part of the team that's revolutionizing business automation. Build the future with us.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              We're building the future of business automation, and we want you to be part of it. Join a team of
              passionate innovators who are making a real impact on businesses worldwide.
            </p>
          </motion.div>
              ...
              >
                <Card className="text-center p-8 h-full hover:shadow-lg transition-shadow">
                  <CardContent className="p-0">
                    <div className="text-ff8e00 mb-4 flex justify-center">{benefit.icon}</div>
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Find your next career opportunity and help us shape the future of automation
            </p>
          </motion.div>
                    ...
                    {expandedJob === job.id && (
                      ...
                      >
                        ...
                        <div className="mt-6 pt-6 border-t">
                          <Button className="bg-ff8e00 hover:bg-orange-600 text-white">Apply Now</Button>
                        </div>
                      </motion.div>
                    )}
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              { step: "1", title: "Apply", description: "Submit your application and resume through our portal" },
              { step: "2", title: "Screen", description: "Initial phone/video screening with our HR team" },
              { step: "3", title: "Interview", description: "Technical and cultural fit interviews with the team" },
              ...
              >
                <div className="w-16 h-16 bg-ff8e00 text-white rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-4">
                  {process.step}
                </div>
        ...
        <div className="container mx-auto px-6 text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto">
              Don't see a position that fits? We're always interested in hearing from talented individuals. Send us your
              resume and let's talk about how you can contribute to our mission.
            </p>
            <Button size="lg" className="bg-ff8e00 hover:bg-orange-600 text-white px-8 py-4 text-lg">
              Send Your Resume
            </Button>
          </motion.div>
        </div>
